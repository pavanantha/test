...
//@Disabled("Wants to do REAL S3 writes per build!")
public class OutageDataTest {
	...
	public void test() throws JsonProcessingException, InterruptedException {
		...
		LoadData2S3 s3 = new LoadData2S3();
		...
		DateTime asOfDate =  DateTime.parse("201909161550", dtFormatter);//DateTime.now();
