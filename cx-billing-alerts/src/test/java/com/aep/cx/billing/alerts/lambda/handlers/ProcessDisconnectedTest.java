 ...
 */
public class ProcessDisconnectedTest {
    ...
    private Context createContext() {
        ...
        ctx.setFunctionName("ProcessDisconnectedTest");

        return ctx;
    }

    @Test
    public void testProcessDisconnected() {
        ...
        when(service.parseS3EventData(s3Event, new Disconnected())).thenReturn(disconnectedList);
        when(service.buildAlertContent(disconnectedList)).thenReturn("Success");
